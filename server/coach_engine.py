...
_BIKE_STEPS = {"bike_goal", "bike_level", "bike_days", "bike_hours", "bike_ftp"}
_RUN_STEPS  = {"run_goal", "run_level", "run_days", "run_miles"}
...
_STEP_META: dict[str, dict] = {
    ...
    "bike_goal":  {"text": "What's your cycling goal?",
                   "type": "quick_reply", "options": _BIKE_GOALS},
    ...
    "run_goal":   {"text": "What's your running goal?",
                   "type": "quick_reply", "options": _RUN_GOALS},
